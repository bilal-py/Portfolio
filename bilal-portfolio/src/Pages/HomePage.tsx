  ...
  <div className="relative min-h-screen w-full" >
      ...
      >
        <section className="w-full max-w-3xl mx-auto text-center">
          <h1 className="text-3xl sm:text-5xl md:text-7xl font-extrabold bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 bg-clip-text text-transparent drop-shadow-lg animate-fade-in-up">
            Bilal Imran
          </h1>
