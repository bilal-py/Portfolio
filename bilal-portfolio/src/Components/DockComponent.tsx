...
// Simple fallback for missing Tooltip
...
// Simple fallback for missing Separator
function Separator({ orientation, className }: { orientation?: string; className?: string }) {
  return <div className={className} style={{ width: orientation === "vertical" ? 1 : undefined, height: orientation === "vertical" ? "100%" : 1, background: "#e5e7eb", margin: 8 }} />;
}
